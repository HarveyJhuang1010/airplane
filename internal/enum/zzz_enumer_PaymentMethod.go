// Code generated by "enumer -type=PaymentMethod -trimprefix=PaymentMethod -yaml -json -text -sql -transform=snake --output=zzz_enumer_PaymentMethod.go"; DO NOT EDIT.
...
func (i PaymentMethod) Value() (driver.Value, error) {
	return i.String(), nil
}

func (i *PaymentMethod) Scan(value interface{}) error {
	if value == nil {
		return nil
	}
	...
	case fmt.Stringer:
		str = v.String()
	default:
		return fmt.Errorf("invalid value of PaymentMethod: %[1]T(%[1]v)", value)
	}

	val, err := PaymentMethodString(str)
	if err != nil {
		return err
	}
