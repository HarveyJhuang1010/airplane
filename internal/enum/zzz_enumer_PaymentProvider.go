// Code generated by "enumer -type=PaymentProvider -trimprefix=PaymentProvider -yaml -json -text -transform=snake --output=zzz_enumer_PaymentProvider.go"; DO NOT EDIT.
