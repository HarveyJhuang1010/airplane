// Code generated by "enumer -type=SeatStatus -trimprefix=SeatStatus -yaml -json -text -sql -transform=snake --output=zzz_enumer_SeatStatus.go"; DO NOT EDIT.
...
func (i SeatStatus) Value() (driver.Value, error) {
	return i.String(), nil
}

func (i *SeatStatus) Scan(value interface{}) error {
	if value == nil {
		return nil
	}
	...
	case fmt.Stringer:
		str = v.String()
	default:
		return fmt.Errorf("invalid value of SeatStatus: %[1]T(%[1]v)", value)
	}

	val, err := SeatStatusString(str)
	if err != nil {
		return err
	}
